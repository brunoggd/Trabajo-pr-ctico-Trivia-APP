...
// const contenedor_el_del_medio = document.querySelector('#1');
...
function decodificarHTML(texto) {
    contenedor_el_del_medio.createElement('textarea');
    // contenedor_el_del_medio.innerHTML = texto;
    // return contenedor_el_del_medio.value;
}
...
function MostrarPregunta(preguntas) {
    ...
    contenedor_pregunta.innerHTML = `<div class="wrapper custom-size-2 question-box-style">
                                    ...
                                    <button class="button-next id="button-next"><p class="question-text">Siguiente<p></button>`;
