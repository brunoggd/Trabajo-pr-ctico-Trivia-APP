...
boton_iniciar_juego.addEventListener('click', async () => {
    if (dificultad_seleccionada && categoria_seleccionada) {
        ...
        console.log("Respuestas sin mezclar:", respuestas);

        Mezclar(respuestas);

        console.log("Respuestas Mezcladas:", respuestas);
        ...
        const boton_rta_1 = document.querySelector('#respuesta-1');

        const boton_rta_2 = document.querySelector('#respuesta-2');

        const boton_rta_3 = document.querySelector('#respuesta-3');

        const boton_rta_4 = document.querySelector('#respuesta-4');

        const botones_respuestas = [boton_rta_1, boton_rta_2, boton_rta_3, boton_rta_4];

        botones_respuestas.forEach(boton => {
            boton.addEventListener('click', () => {
                const respuesta_elegida = boton.textContent;

                game.responder(respuesta_elegida);
            });
        });
